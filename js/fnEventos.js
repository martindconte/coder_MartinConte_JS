  ...
  if (btnClick.tagName == "BUTTON") {
    ...
    if (btnClick.getAttribute("data-id") == "modificar") {
      ...
      document.getElementById(`${idTabla}AceptarBtn`).onclick = () => {
        ...
        //     const {
        //       objetosRepetidos: objIngresadoRepetidos,
        //       clavesRepetidas: clavesValoresRepetidos,
        //     } = buscarDatosRepetidos(arrayNuevosDatos,arrayNuevosDatos,arrayClavesNoRepetir);
        ...
        //       // oculto los botones
        //       document
        //         .getElementById(`${idTabla}AceptarBtn`)
        //         .classList.add("oculto");
        //       document
        //         .getElementById(`${idTabla}DescartarBtn`)
        //         .classList.add("oculto");
        //       // actualizo la tabla con los nuevos valores
        //       tablaHorizontal(array, idTabla);
        //       // vuelvo a inicializar las variables
    ...
    if (btnClick.getAttribute("data-id") == "eliminar") {
      ...
      document.getElementById(`${idTabla}EliminarBtn`)
...
//             break;
//           case "marca":
//             switch (variableLS == 'modelos') {
//               case true:
//                 td.textContent = "";
//                 const selectMarcas = crearSelect(marcasRegistradas);
//                 td.appendChild(selectMarcas);
//                 selectMarcas.value = value;
//                 break;
//               case false:
...
//         divModal.id = `${idTabla}Modal`;
//         tabla.appendChild(divModal);
//         crearModalConfirmacion("¿Esta seguro que desea ELIMINAR los datos seleccionados? SITUACION IRREVERSIBLE", `${idTabla}Modal`);
//         // confirmacion en modal de aceptar borrar usuarios
//         document.getElementById(`${idTabla}ModalConfirmar`).onclick = () => {
//           array = eliminarElementoArray(array, auxKeyEliminar);
//           ordenarArray(array, ordenArray);
